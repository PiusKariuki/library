<template>
  <div class="flex flex-col lg:flex-row w-full pad mt-16 gap-10">
    <div class="flex flex-col w-full gap-12 lg:w-1/2">
      <p class="text-5xl leading-tight font-normal lg:font-medium mx-w-xs lg:text-left">Readily Book Library</p>
      <p class="lg:text-left lg:max-w-sm font-medium text-lg tracking-wider text-secondary">
